...
INSERT INTO Permit (PermitID, PermitType, StartDate, ExpDate, ExpTime, AssignedSpaceType, AssignedZoneID, DriverID)
VALUES ('EIG3C', 'Commuter', '2023-01-01', '2024-01-01', '06:00:00', 'Regular', 'A', 466399121),
       ('EJC1R', 'Residential', '2010-01-01', '2030-01-01', '06:00:00', 'Electric', 'A', 266399121),
       ('EJH2C', 'Commuter', '2023-01-01', '2024-01-01', '06:00:00', 'Regular', 'A', 366399121),
       ('SST1R', 'Residential', '2022-01-01', '2023-09-30', '06:00:00', 'Compact Car', 'AS', 122765234),
       ('VCX1SE', 'Special Event', '2023-01-01', '2023-11-15', '06:00:00', 'Handicap', 'V', 9194789124),
       ('VSBF1C', 'Commuter', '2023-01-01', '2024-01-01', '06:00:00', 'Regular', 'V', 7729119111);
